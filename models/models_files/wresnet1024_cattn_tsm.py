...
from models.basic_modules import ConvBnRelu, ConvTransposeBnRelu, initialize_weights,UP , UpScale
...
class ASTNet(nn.Module):
    ...
    def __init__(self, config, pretrained=True):
        ...
        self.up8 = UP(channels[3], channels[3],kernel_size=2) 
        self.up4 = UP(channels[3], channels[3],kernel_size=2) 
        self.up2 = UP(channels[3], channels[3],kernel_size=2)
        self.up = UpScale(channels[3], channels[3],kernel_size=2) 
        ...
        initialize_weights(self.up2, self.up4, self.up8,self.up)
    ...
    def forward(self, x):
        ...
        x8 = F.interpolate(x8, scale_factor=0.5, mode='bilinear', align_corners=False)
    ...
    def compute_loss(self, x):
        ...
        loss_commit = self._commitment_cost * 0.0
